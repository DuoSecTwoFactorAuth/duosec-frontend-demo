...
import { validateEmpDetails, addEmployee } from "../AdminPage/form-utils"
import routes from "../../config/routes-config";

const AddEmployeeModal = ({ setEmployeesDetails, showAddEmpModal, setShowAddEmpModal, toast }) => {
    if (!showAddEmpModal) {
        return null;
    }
    ...
    const handleSubmitEmpDetails = (event) => {
        ...
        if (Object.keys(formErrors).length === 0) {
            addEmployee(routes.admin.addEmployee, empDetails, setEmpDetails, setEmployeesDetails, toast);
        }
    }
